...
import { difficultyLabel, formatHours, getRecipe, img, recipes, regionLabel, related } from "@/lib/data";
  ...
  return (
    <main>
      <section className="relative min-h-[52vh] overflow-hidden">
        <img src={img(r.image)} alt={r.title} className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-10 pt-28">
          ...
          <div className="mt-4 flex items-start justify-between gap-4">
            <h1 className="font-display text-5xl italic text-cream md:text-6xl">{r.title}</h1>
        ...
        <div>
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            {[["Time", formatHours(r.hours)], ["Pit", r.pitTemp], ["Done", r.finish], ["Wood", r.wood]].map(([k, v]) => (
              <div key={k} className="rounded-2xl border border-white/8 bg-bark p-4">
